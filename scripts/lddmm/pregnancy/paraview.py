...
with open("result_path_place_holder" "/visualisation_names.json", "r") as fp:
...
# create a new 'Legacy VTK Reader'
initial_control_points_regression = LegacyVTKReader(
    **filenames["initial_cp_regression"]
)

# create a new 'Legacy VTK Reader'
initial_control_points_registration = LegacyVTKReader(
    **filenames["initial_cp_registration"]
)

# create a new 'Glyph'
vel = Glyph(
    registrationName="vel", Input=initial_control_points_regression, GlyphType="Arrow"
)
...
# create a new 'Glyph'
vel_1 = Glyph(
    registrationName="vel", Input=initial_control_points_registration, GlyphType="Arrow"
)
...
# create a new 'Glyph'
momenta = Glyph(
    registrationName="momenta",
    Input=initial_control_points_regression,
    GlyphType="Arrow",
)
...
momenta_1 = Glyph(
    registrationName="momenta",
    Input=initial_control_points_registration,
    GlyphType="Arrow",
)
...
initial_control_points_registrationDisplay = Show(
    initial_control_points_registration, renderView1, "GeometryRepresentation"
)

# get color transfer function/color map for 'Momentum'
momentumLUT = GetColorTransferFunction("Momentum")
momentumLUT.RGBPoints = [
    0.006285316954890572,
    0.231373,
    0.298039,
    0.752941,
    4.673110955213255,
...
initial_control_points_registrationDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
vel_1Display.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
vel_1Display.ScaleTransferFunction.Points = [
    -1.0873324533164452,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
vel_1Display.OpacityTransferFunction.Points = [
    -1.0873324533164452,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
momenta_1Display.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
momenta_1Display.ScaleTransferFunction.Points = [
    -1.2058828128559589,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
momenta_1Display.OpacityTransferFunction.Points = [
    -1.2058828128559589,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
registrationDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
sourceDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
regressionDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
initial_control_points_regressionDisplay = Show(
    initial_control_points_regression, renderView1, "GeometryRepresentation"
)
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
initial_control_points_regressionDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
momentaDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
momentaDisplay.ScaleTransferFunction.Points = [
    -1.1737351132147464,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
momentaDisplay.OpacityTransferFunction.Points = [
    -1.1737351132147464,
    0.0,
    0.5,
    0.0,
...
separate_velDisplay_MomentumLUT = GetColorTransferFunction(
    "Momentum", velDisplay, separate=True
)
separate_velDisplay_MomentumLUT.RGBPoints = [
    0.6279259188570192,
    0.231373,
    0.298039,
    0.752941,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
velDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
velDisplay.ScaleTransferFunction.Points = [
    -1.1737351132147464,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
velDisplay.OpacityTransferFunction.Points = [
    -1.1737351132147464,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
target_shapeDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
target_shapeDisplay.ScaleTransferFunction.Points = [
    184.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
target_shapeDisplay.OpacityTransferFunction.Points = [
    184.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
raw_dataDisplay.OSPRayScaleFunction.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
raw_dataDisplay.ScaleTransferFunction.Points = [
    184.0,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
raw_dataDisplay.OpacityTransferFunction.Points = [
    184.0,
    0.0,
    0.5,
    0.0,
...
significativeDiffMeanMomentumLUT.RGBPoints = [
    0.0,
    0.231373,
    0.298039,
    0.752941,
...
meanForceLUT.RGBPoints = [
    0.037401204972628194,
    0.231373,
    0.298039,
    0.752941,
    3.8383138989924097,
...
separate_velDisplay_MomentumLUTColorBar = GetScalarBar(
    separate_velDisplay_MomentumLUT, renderView1
)
...
separate_velDisplay_MomentumPWF = GetOpacityTransferFunction(
    "Momentum", velDisplay, separate=True
)
separate_velDisplay_MomentumPWF.Points = [
    0.6279259188570192,
    0.0,
    0.5,
    0.0,
...
significativeDiffMeanMomentumPWF.Points = [
    0.0,
    0.0,
    0.5,
    0.0,
